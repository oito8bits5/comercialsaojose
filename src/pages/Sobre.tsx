...
const milestones = [
  { year: "2004", title: "Fundação", description: "O Mercadinho Familiar abre suas portas com apenas 50m²" },
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Conheça a história do Mercadinho Familiar e os valores que 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    O Mercadinho Familiar nasceu em 2004, fruto do sonho de uma família 
              ...
              >
                <img
                  src={storeExterior}
                  alt="Fachada do Mercadinho Familiar"
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <img
                  src={teamImage}
                  alt="Equipe do Mercadinho Familiar"
                  className="rounded-2xl shadow-elevated w-full"
                />
              </motion.div>
              <motion.div
